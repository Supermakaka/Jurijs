    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                BrowserRemembered = await authManager.TwoFactorBrowserRememberedAsync(UserId.ToString())
            };
            return View(model);
        }
        ...
        public async Task<ActionResult> ManageLogins(ManageMessageId? message)
        {
            ...
            var otherLogins = authManager.GetExternalAuthenticationTypes().Where(auth => userLogins.All(ul => auth.AuthenticationType != ul.LoginProvider)).ToList();
